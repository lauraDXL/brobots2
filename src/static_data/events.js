...
import mai from '../assets/events/27mai.jpg';
import mai2 from '../assets/events/27mai2.jpg';
import mai3 from '../assets/events/27mai3.jpg';
import mai4 from '../assets/events/27mai4.jpg';
import mai5 from '../assets/events/27mai5.jpg';
import mai6 from '../assets/events/27mai6.jpg';
import costesti from '../assets/events/costesti.jpg';
import costesti2 from '../assets/events/costesti2.jpg';
import costesti3 from '../assets/events/costesti3.jpg';
import costesti4 from '../assets/events/costesti4.jpg';
import costesti5 from '../assets/events/costesti5.jpg';
import targed from '../assets/events/targ.jpg';
import targed2 from '../assets/events/targ2.jpg';
import targed3 from '../assets/events/targ3.jpg';
import targed4 from '../assets/events/targ4.jpg';
import targed5 from '../assets/events/targ5.jpg';
import brezoi from '../assets/events/brezoi.jpg';
...
import final from '../assets/events/final.jpg';
...
key:'sisteme_microprocesoarefinal',
 ...
 location_en: 
  ...
  title_en:
  'Systems with microprocessors - funded event Meet and Code at the "Alexandru Lahovari" National College',
  description:
  'În perioada 10-11 septembrie 2022, în organizarea Asociației Lahovari și a echipei de robotică BroBots, va avea loc evenimentul Sisteme cu microprocesoare ce își propune propune familiarizarea participanților cu concepte ale sistemelor embedded. Ne adresăm elevilor de liceu care au cunoștințe elementare de informatică / TIC. În cadrul wokshop-ului vor putea învăța despre: 1.Modul de funcționare al unui microprocesor ; 2.Circuite logice, instrucțiuni low level și interfațarea cu dispozitive externe. De asemenea vor putea realiza aplicații folosind plăcuțe Arduino si diferiți senzori. Ceea ce face evenimentul special este interacțiunea cu hadware-ul. Trainer va fi Marian Stoica - embedded engineer at Protoforge. Marian este alumn Lahovari și membru al comisiei naționale a Olimpiadei de inovare și creație digitală InfoEducație - secțiunea roboți.Evenimentul a câștigat o finanțare prin programul Meet and code susținut la nivel european de compania de software SAP. În România, programul este coordonat pentru cel de-al 6-lea an consecutiv de #AsociațiaTechsoup și susține evenimente de tehnologie și programare aliniate cu misiunea inițiativei Comisiei Europene: Europe Code Week.',
  description_en:
 ...
 location_en: 
 ...
 
  {
    ...
    title_en:
    'BroBotSTEAM Summer School - Series I, Day 3',
    description:
    'Final de Școală de vară pentru seria I. Ziua 3 s-a desfășurat în aceeași atmosferă de entuziasm, dorință de a învăța lucruri noi, de a lega prietenii cu copii care au aceleași pasiuni. Toți participanții au realizat proiecte Arduino sub îndrumarea membrilor echipei noastre. Le mulțumim tuturor participanților, ne bucurăm că am petrecut 3 zile atât de frumoase alături de ei și îi așteptăm și la viitoarele evenimente organizate de noi. Proiectul BroBotSTEAM este finanțat prin Fondul Științescu Vâlcea, implementat de către Fundaţia Comunitară Vȃlcea, în parteneriat cu Romanian-American Foundation  și  Federaţia Fundaţiile Comunitare din România - FFCR.',
    description_en:
    'Final of the Summer School for series I. Day 3 took place in the same atmosphere of enthusiasm, desire to learn new things, to make friends with children who have the same passions. All participants made Arduino projects under the guidance of our team members. We thank all the participants, we are glad that we spent 3 such beautiful days with them and we are waiting for them at the future events organized by us. The BroBotSTEAM project is financed by the Științescu Vâlcea Fund, implemented by the Vȃlcea Community Foundation, in partnership with the Romanian-American Foundation and the Federation of Community Foundations in Romania - FFCR.',
     images:[final2,final3,final4],
    cover:final,
     location: 
      'Colegiul Național "Alexandru Lahovari"',
     location_en: 
 ...
 
 {
  ...
  description_en: 
    'If last week we were present at the Educational Offers Fair, yesterday we honored the invitation to be present among the 8th grade students from Secondary School No. 5 Ramnicu-Valcea. It was an interesting meeting. Razvan Mutuleasa, Andrei Nicolae and Laura Simion spoke to those present about our high school, about what it means to be a student at Lahovari but also about robotics, STEM education and the BRD FIRST Tech Challenge Romania competition. I also presented them with the robot with which I participated in the robotics competition this year. We enjoyed the interest shown by our younger colleagues and answered all their questions. We hope to meet as many of them as possible in the fall as students in the 9th grade at Lahovari College. We wish them good luck in the upcoming exam!', 
 ...
 
 {
 ...
 
  {
    ...
    description_en:
      'High school mentors from the BroBots Team robotics team set out to popularize the concept of non-formal STEM education. BroBotSTEAM is about helping students put what they have learned in school into practice by developing projects on Arduino boards. Their project has two components, the creation of a mobile microcontroller workshop to be able to reach 5 rural schools and a summer school that will be held at the Alexandru Lahovari National College for urban youth. In addition to their passion for robotics, the BroBots are actively involved in the development of non-formal education and civil society. We congratulate them once again for their involvement and wish them success in everything they set out to do. The project is financed by the Șiințescu Vâlcea Fund, implemented by the Vȃlcea Community Foundation (FCVL), in partnership with the Romanian-American Foundation (RAF) and the Community Foundations Federation of Romania (FFCR). For more information, go to https://valcea.stiintescu.ro/proiecte-2022/template-proiect/',
    description:
